...
(function () {
  ...
  VM.data = {
    ...
    projects: [
      { slug: 'leading-aiesec-rwanda', title: 'Leading AIESEC in Rwanda', category: 'leadership', category_label: 'Leadership', badge: 'National Operations', year: '2023–Present', featured: true, summary: 'Directed national operations managing 300+ members, national teams, local chapters, and strategic partnerships.', description: 'A comprehensive national leadership initiative scaling organizational impact across Rwanda.', image: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=900&q=80', overview: 'As Country Director, Vicent Manila leads the full national operations of AIESEC in Rwanda — one of the organization\'s most dynamic entities in East Africa. The role encompasses membership management, partnership strategy, national project delivery, and international representation.', challenge: 'Scale national operations while maintaining leadership quality, stakeholder alignment, and sustainable organizational growth across multiple concurrent initiatives.', objectives: ['Strengthen national team structure and local chapter performance', 'Align board advisors and partners under a unified growth framework', 'Deliver measurable impact across national projects and membership engagement'], role: 'Country Director — full accountability for national strategy, operations, and stakeholder relationships.', strategy: 'Restructured national teams, introduced performance systems, and aligned local chapters under centralized governance with decentralized execution.', execution: 'Led cross-department coordination, managed board relationships, oversaw partnership portfolios, and directed multiple national projects simultaneously.', results: ['300+ members and alumni under active management', 'Strengthened partner engagement and national project delivery', 'Improved organizational governance and team performance metrics'], impact: 'Established AIESEC in Rwanda as a nationally credible youth leadership institution with stronger corporate and institutional partnerships.', gallery: ['https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&q=80', 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80'], related: ['global-money-week-partnerships', 'international-bd-support'] },
      { slug: 'global-money-week-partnerships', title: 'Global Money Week Partnerships', category: 'business-development', category_label: 'Business Development', badge: 'National Campaign', year: '2023', featured: true, summary: 'Secured two national partners and five campaign partnerships for Global Money Week 2023.', description: 'Strategic partnership acquisition for a nationally significant financial literacy campaign.', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=900&q=80', overview: 'Global Money Week required rapid partnership acquisition with corporate and institutional stakeholders aligned to financial literacy and youth empowerment objectives.', challenge: 'Deliver high-value partnerships within a compressed timeline for a nationally visible campaign with multiple stakeholder expectations.', objectives: ['Secure national-level partners for campaign credibility', 'Close five supporting partnerships for campaign execution', 'Align corporate CSR goals with campaign impact metrics'], role: 'Head of Business Development — end-to-end partnership strategy, negotiation, and campaign integration.', strategy: 'Developed targeted outreach, tailored value propositions for corporate CSR objectives, and structured tiered partnership packages.', execution: 'Led stakeholder presentations, negotiated terms, coordinated campaign integration, and managed partner relationship handoffs.', results: ['Two national partners signed', 'Five campaign partnerships closed', 'Successful Global Money Week delivery enabled'], impact: 'Demonstrated capacity to deliver corporate partnerships under pressure — a model replicated in subsequent national campaigns.', gallery: ['https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&q=80'], related: ['leading-aiesec-rwanda', 'employer-branding-rwanda'] },
      { slug: 'international-bd-support', title: 'International Business Development Support', category: 'international-partnerships', category_label: 'International Partnerships', badge: 'Global Initiative', year: '2023', featured: true, summary: 'Supported and consulted 100+ country BD managers through AIESEC International.', description: 'Global business development consultation and co-sales support across 100+ countries.', image: 'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=900&q=80', overview: 'As a member of the Business Development Steering Team at AIESEC International, Vicent provided scalable strategic guidance to country BD managers operating in diverse markets with varying maturity levels.', challenge: 'Provide meaningful, scalable BD guidance across 100+ countries with different market contexts, maturity levels, and resource constraints.', objectives: ['Strengthen BD capabilities across global operations', 'Develop reusable consultation and co-sales frameworks', 'Improve cross-border collaboration and knowledge sharing'], role: 'BD Steering Team Member — strategic consultation, co-sales support, and framework development.', strategy: 'Built consultation playbooks, co-sales frameworks, and structured knowledge-sharing systems for global BD teams.', execution: 'Delivered strategic sessions, supported co-sales initiatives, and facilitated cross-border BD collaboration.', results: ['100+ country BD managers supported', 'Improved global BD alignment and partnership outcomes', 'Frameworks adopted across multiple regions'], impact: 'Elevated global partnership standards and strengthened AIESEC\'s international BD ecosystem.', gallery: ['https://images.unsplash.com/photo-1505373877841-8d25f39ca311?w=800&q=80'], related: ['leading-aiesec-rwanda', 'international-conference-bids'] },
      { slug: 'employer-branding-rwanda', title: 'Employer Branding Strategy — Rwanda', category: 'employer-branding', category_label: 'Employer Branding', badge: 'Corporate Relations', year: '2022–2023', featured: false, summary: 'Strengthened employer branding and corporate positioning for national partnership growth.', description: 'National employer branding initiative connecting corporate partners with youth talent pipelines.', image: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=900&q=80', overview: 'Developed and executed employer branding strategy positioning AIESEC in Rwanda as a premier youth talent partner for corporate organizations.', challenge: 'Differentiate AIESEC\'s employer value proposition in a competitive corporate partnership landscape.', objectives: ['Strengthen corporate brand positioning', 'Increase sponsorship conversion rates', 'Build long-term employer relationships'], role: 'Head of Business Development & Employer Branding.', strategy: 'Created employer branding materials, partnership value frameworks, and corporate engagement playbooks.', execution: 'Led corporate presentations, managed relationship pipelines, and coordinated branding across national touchpoints.', results: ['Improved corporate engagement metrics', 'Stronger national partner retention'], impact: 'Positioned AIESEC in Rwanda as a credible employer branding partner for national corporations.', gallery: [], related: ['global-money-week-partnerships'] },
      { slug: 'ifm-chapter-growth', title: 'IFM Local Chapter Growth', category: 'youth-development', category_label: 'Youth Development', badge: 'Chapter Leadership', year: '2020–2022', featured: false, summary: 'Led 25+ members and delivered measurable organizational growth at AIESEC in IFM.', description: 'Local chapter leadership and growth initiative at the Institute of Finance Management, Tanzania.', image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=900&q=80', overview: 'As Local Committee President, built foundational leadership systems and drove chapter growth at IFM.', challenge: 'Build a high-performing local chapter with limited resources and developing institutional partnerships.', objectives: ['Grow membership and engagement', 'Develop executive board capabilities', 'Establish local partnerships'], role: 'Local Committee President.', strategy: 'Implemented structured leadership development, clear role accountability, and partnership outreach.', execution: 'Managed executive board, led 25+ members, and built local institutional relationships.', results: ['Measurable chapter growth achieved', 'Executive team development programs established'], impact: 'Created leadership foundation that enabled national and international career trajectory.', gallery: [], related: ['leading-aiesec-rwanda'] },
      { slug: 'international-conference-bids', title: 'International Conference Bid Management', category: 'international-conferences', category_label: 'International Conferences', badge: 'Global Operations', year: '2022–2023', featured: false, summary: 'Managed bid evaluation and host coordination for international conferences within AIESEC.', description: 'Cross-border conference bid management and host coordination for international events.', image: 'https://images.unsplash.com/photo-1475721027785-f74eccf83e40?w=900&q=80', overview: 'Coordinated multi-country bid processes for international conferences with structured evaluation and stakeholder alignment.', challenge: 'Manage complex bid evaluation across multiple countries with competing priorities and stakeholder expectations.', objectives: ['Ensure fair and structured bid evaluation', 'Align host coordination with international standards', 'Deliver successful conference outcomes'], role: 'Operations & International Relations Lead.', strategy: 'Developed evaluation criteria, stakeholder communication protocols, and host coordination frameworks.', execution: 'Managed bid processes, coordinated with international teams, and oversaw host preparation.', results: ['Successful bid evaluations completed', 'International conference delivery supported'], impact: 'Strengthened AIESEC\'s international conference operations and cross-border coordination.', gallery: [], related: ['international-bd-support'] },
    ],
    ...
    testimonials: [
      { name: 'Sarah Nkusi', position: 'Regional Director', organization: 'AIESEC East Africa', quote: 'Vicent brings a rare combination of strategic vision and operational rigor. His ability to build partnerships while leading large teams has been instrumental to our regional growth.', initials: 'SN', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&q=80' },
      { name: 'James Ochieng', position: 'Head of Corporate Partnerships', organization: 'Leading Financial Institution', quote: 'Working with Vicent on Global Money Week was seamless. His professionalism in stakeholder management and ability to align corporate goals with social impact set a new standard.', initials: 'JO', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&q=80' },
      { name: 'Marie Uwase', position: 'Local Committee Vice President', organization: 'AIESEC in Rwanda', quote: 'An inspiring leader who empowers youth, fosters growth, and leads by example. Vicent creates environments where young people thrive and deliver real results.', initials: 'MU', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&q=80' },
    ],
